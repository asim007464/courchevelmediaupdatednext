...
const logoSrc = "public/brand-icon-96-removebg-preview.png";
...
(async () => {
  ...
  await writePng(48, "public/cm-icon-48.png");
  await writePng(96, "public/cm-icon-96.png");
  await writePng(192, "public/cm-icon-192.png");
  ...
  const icoBuf = await pngToIco([
    "public/cm-icon-48.png",
    "public/cm-icon-96.png",
  ]);
  fs.writeFileSync("public/favicon.ico", icoBuf);
  fs.writeFileSync("public/cm-favicon.ico", icoBuf);
  console.log("wrote public/favicon.ico + public/cm-favicon.ico", icoBuf.length, "bytes");
