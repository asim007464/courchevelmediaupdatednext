...
export function mapBlogToGuide(blog, index = 0) {
  return {
    ...
    metaDescription: blog.meta_description || blog.lead || "",
    ...
    coverAlt: blog.cover_alt || blog.title || "",
    author: blog.author || "Courchevel Media",
    publishedAt: blog.published_at || blog.created_at || null,
    updatedAt: blog.updated_at || blog.published_at || blog.created_at || null,
...
export function mapDesignGuide(guide) {
  return {
    ...
    metaDescription: guide.metaDescription || guide.description || "",
    author: guide.author || "Courchevel Media",
