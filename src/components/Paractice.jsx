...
// import imgadriana7 from "@/images/Ski/Adriana Howerton - Brasil/IMG_9130.jpg";
...
// import Swae2 from "@/images/Events/Swae Lee - Private party/IMG_2170-Enhanced-NR.jpg";
...
//       location: "Private party",
//       type: "events",
//       images: [Bob1, Bob2, Bob3, Bob4, Bob5, Bob6, Bob7, Blondish8],
//     },
//     {
//       name: "Claptone ",
//       location: "Private party",
...
//       location: "Event",
//       type: "events",
//       images: [Folie1, Folie2, Folie3, Folie4, Folie5, Folie6, Folie7],
//     },
//     {
//       name: "Mangeoire",
...
//       type: "events",
//       images: [Marina1, Marina2, Marina3, Marina4, Marina5, Marina6],
//     },
//     {
//       name: "Morgen Shtern",
//       location: "Private party",
...
//       location: "Private party",
//       type: "events",
//       images: [Swae1, Swae2, Swae3, Morgen4, Morgen5, Morgen6],
//     },
//   ];
...
//   const [sliderimgs, setsliderimgs] = useState(0);

//   function leftarrow() {
//     if (sliderimgs > 0) {
//       setsliderimgs(sliderimgs - 1);
...
//                                 <div
//                                   className="card top-[250px] card-testimonial absolute "
//                                   style={{
//                                     width: "50px",
//                                     height: "50px",
//                                     borderRadius: "50px",
...
//                                   <div
//                                     onClick={leftarrow}
//                                     className="text-color-white relative top-[25px] flex justify-center items-center"
//                                   >
//                                     <i className="fa-solid fa-arrow-left text-white  relative top-[-8px] "></i>
//                                   </div>
//                                 </div>
//                                 <img
//                                   className={`w-[100%] h-[600px] object-cover transition-opacity duration-500 ease-in-out ${"opacity-100"}`}
//                                   src={person.images[sliderimgs]}
//                                   alt="Image Slider"
//                                 />
//                                 <div className="circlemain  absolute bottom-[-90px]">
...
//                                 </div>
//                                 <div
//                                   className="card top-[250px] right-0 card-testimonial absolute "
//                                   style={{
//                                     width: "50px",
//                                     height: "50px",
//                                     borderRadius: "50px",
